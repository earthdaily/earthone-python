...
class TestFunctionBundle(FunctionTestCase):
    ...
    def get_init_files(self, path):
        ...
        segments = ["/".join(parts[:i + 1]) + "/__init__.py" for i in range(len(parts))]
        return segments
    ...
    def test_function_bundling(self):
        ...
        params = {
            ...
            "include_data": [os.path.join(current_directory_os_aware, "data", "test_data1.csv")],
        }
    ...
    def test_function_bundling_requirements_file(self):
        ...
        params = {
            ...
            "timeout": 60,
            "retry_count": 1,
            "requirements": os.path.join(current_directory_os_aware, "requirements.txt"),
